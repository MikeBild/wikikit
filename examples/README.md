...
| [`agent-hooks/`](agent-hooks)                                          | SessionStart/SessionEnd hooks for Claude Code and Codex — load the concept index into a session, capture what it taught. Setup: [docs/coding-agent-integration.md](../docs/coding-agent-integration.md). |
