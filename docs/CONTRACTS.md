...
| GET    | `/v1/audit`                                    | knowledge:read                      | `listAuditHandler`             | query `zAuditListQuery`                                                       | 200 `zAuditListResponse` — the append-only audit trail (audit.v1), newest first, keyset-paged on `seq`, with a `page` block carrying `next_cursor`/`has_more`/`total`/`total_exact`                                                                                                                                                                                                                                                                                                                                                                                  |
