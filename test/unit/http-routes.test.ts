...
const CONTRACT_TABLE: [string, string, string | null][] = [
  ...
  ['get', '/v1/spaces/{space}/charter', 'knowledge:read'],
  ['get', '/v1/spaces/{space}/charter/versions', 'knowledge:read'],
  ['put', '/v1/spaces/{space}/charter', 'admin'],
  ['delete', '/v1/spaces/{space}/charter', 'admin'],
  ...
  ['get', '/v1/ingests/{id}/triage', 'knowledge:propose'],
  ['post', '/v1/ingests/{id}/triage', 'knowledge:propose'],
  ['post', '/v1/ingests/{id}/triage/resolve', 'knowledge:propose'],
  ...
  ['get', '/v1/spaces/{space}/attention', 'knowledge:read'],
  ['put', '/v1/spaces/{space}/attention/{key}', 'knowledge:propose'],
  ...
  ['get', '/v1/spaces/{space}/stats/llm', 'knowledge:read'],
  ['get', '/v1/spaces/{space}/stats/webhooks', 'knowledge:read'],
  ['get', '/health', null],
  ['get', '/ready', null],
  ['get', '/metrics', null],
