...
Version 1.4 · 17.08.2026 · WikiKit-Adaption
...
Referenz-Implementierung ist das WikiKit-Cockpit selbst. Bei Unklarheit gelten die gerenderten, durch Browser- und Vertragstests geprüften Zustände.

Änderungen v1.1: neuer §8 Entscheidungs-Grammatik; §1 Zone A verweist auf §8.
Änderungen v1.2: neue §9 Diff-Freigabe, §10 Sammlungs-Listen, §11 Verbindungs-Status; §4 um „Leere führt zur Handlung" ergänzt.
...
**Zone B — Kernobjekt-Hero.** Im WikiKit sind das Fragen-Karten und der Zustand des geprüften Wissens.

**Zone C — Zuletzt geschehen.** Letzte Läufe/Änderungen, jede Zeile klickbar.

Regeln: Kein Zähler ohne Link. Kein Rot ohne Weg zur Ursache. Betriebsmetriken (HTTP, p95, Calls) wohnen unter Installation → System, nie auf dem Startscreen. „Nichts zu tun" ist nur dann ein Erfolg, wenn eine aktuelle Prüfung diesen Zustand belegt.
...
**Kanonische Gruppennamen.** Die Admin-Gruppe heißt **„Installation"** (nie „Administration"), der Entscheidungs-Eintrag ist **ungruppiert** unter der Übersicht (§8.1), die Rolle heißt **„Administrator"** (eine Schreibweise, keine Versalien-Varianten). WikiKit-spezifische Gruppen bleiben frei benannt — aber deutsch und in Normalschreibung.

## 7. Drift-Kontrolle ohne Shared Code

Die Konvention wird in WikiKit durch fokussierte Vertrags-, Komponenten- und Browserprüfungen abgesichert. Eine Änderung an dieser Datei und eine Änderung am Cockpit werden gemeinsam geprüft; beispielsweise darf kein „Unbekannt"-Status im DOM der Übersicht erscheinen.

## 8. Entscheidungs-Grammatik

WikiKit sammelt menschliche Entscheidungen (Freigaben, Reviews und Proposals) auf **einer** Entscheidungs-Seite. Sie beantwortet die drei Fragen in dieser Reihenfolge: Was passiert? Braucht es mich? Was tue ich dann?
