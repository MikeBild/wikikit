 ...
 * on apps/cockpit. Nothing outside this file has ever needed the variants; when
 * something does, it needs a component, not a class string.
 *
 * `data-icon=inline-start|inline-end` is the registry's convention for padding a
 * button that carries an icon on one side. It is honoured here so a component
 * pasted from the registry keeps working.
 */
