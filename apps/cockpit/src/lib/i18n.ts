...
const EN = {
  ...
  'home.compact.taskSummary': '{count} open · oldest {days} days',
  'home.compact.taskSummaryEmpty': '0 open',
  'home.compact.taskSummaryUndated': '{count} open · no dated task',
...
const DE: Record<TranslationKey, string> = {
  ...
  'home.compact.taskSummary': '{count} offen · älteste {days} Tage',
  'home.compact.taskSummaryEmpty': '0 offen',
  'home.compact.taskSummaryUndated': '{count} offen · keine datierte Aufgabe',
