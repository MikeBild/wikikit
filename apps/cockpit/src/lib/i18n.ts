...
const EN = {
  ...
  'page.home.description': 'See every wiki first, then continue in the selected wiki.',
  ...
  'page.answers.description':
    'Every answer, briefing and check report this wiki has produced — and which of them were filed back into it.',
  ...
  'home.openDecisions': 'Open decisions',
  'home.attention.title': 'Open work',
  'home.attention.description': 'The next concrete tasks in this wiki.',
  'home.attention.empty': 'Nothing is waiting.',
  'home.attention.error': 'Open work could not be loaded',
  'home.search.title': 'Find knowledge',
  'home.search.description': 'Search approved pages in this wiki.',
  'home.search.placeholder': 'What are you looking for?',
  'home.search.action': 'Search',
  'home.knowledge.title': 'Knowledge at a glance',
  'home.knowledge.description': 'A selection of approved pages.',
  'home.knowledge.all': 'All pages',
  'home.knowledge.empty': 'This wiki has no approved pages yet.',
  'home.recent.title': 'Recently decided',
  'home.global.title': 'Across every wiki',
  'home.global.description': 'Your knowledge areas and the decisions that actually need you.',
  'home.global.all': 'All wikis',
  'home.global.production': 'Production wikis',
  'home.global.open': 'Open decisions',
  'home.global.oldest': 'Oldest decision',
  'home.global.loading': 'Loading wikis…',
  'home.global.error': 'The wiki overview could not be loaded.',
  'home.global.noPurpose': 'No purpose described',
  'home.global.empty': 'No decision is waiting in a production wiki.',
  'home.current.title': 'In this wiki: {space}',
  'home.current.description': 'Find knowledge and work in the selected wiki.',
  'time.today': 'today',
  'time.oneDay': '1 day',
  'time.days': '{count} days',
  'attention.state.open': 'Open',
  'attention.state.deferred': 'Deferred',
  'attention.state.discarded': 'Discarded',
  'attention.state.decided': 'Decided',
  'attention.kind.all': 'Everything',
  'attention.kind.proposal': 'Proposal',
  'attention.kind.triage': 'Sort inbox',
  'attention.kind.output': 'Result',
  ...
  'attention.effect.output': 'Review whether this result should enter the normal knowledge workflow.',
  'decisions.filters': 'Decision filters',
  'decisions.needsAttention': 'Needs attention',
  'decisions.waitingLonger': 'Waiting longer than three days',
  'decisions.loading': 'Loading decisions…',
  'decisions.error': 'Decisions could not be loaded',
  'decisions.overdueTitle': 'A reminder is overdue',
  'decisions.overdueDescription': '{count} deferred tasks reached their reminder time.',
  'decisions.empty.filtered': 'Nothing matches these filters',
  'decisions.empty.open': 'Nothing needs a decision',
  'decisions.empty.other': 'There are no items in this view.',
  ...
  'decisions.restore': 'Return to open',
  ...
  'decisions.removeConfirmDescription': 'It disappears from the open task list. You can restore it in Discarded.',
  ...
  'spaces.showTests': 'Show test wikis',
...
const DE: Record<TranslationKey, string> = {
  ...
  'page.home.description': 'Erst alle Wikis überblicken, dann im ausgewählten Wiki weiterarbeiten.',
  'page.inbox.description':
  ...
  'page.answers.description':
    'Alle Antworten, Kurzberichte und Prüfberichte dieses Wikis – und welche davon zurück ins Wiki übernommen wurden.',
  ...
  'home.openDecisions': 'Entscheidungen öffnen',
  'home.attention.title': 'Offene Aufgaben',
  'home.attention.description': 'Die nächsten konkreten Aufgaben in diesem Wiki.',
  'home.attention.empty': 'Keine Aufgabe wartet.',
  'home.attention.error': 'Offene Aufgaben konnten nicht geladen werden',
  'home.search.title': 'Wissen finden',
  'home.search.description': 'Freigegebene Seiten in diesem Wiki durchsuchen.',
  'home.search.placeholder': 'Wissen durchsuchen',
  'home.search.action': 'Suchen',
  'home.knowledge.title': 'Wissen auf einen Blick',
  'home.knowledge.description': 'Eine Auswahl freigegebener Seiten.',
  'home.knowledge.all': 'Alle Seiten',
  'home.knowledge.empty': 'Dieses Wiki hat noch keine freigegebenen Seiten.',
  'home.recent.title': 'Kürzlich entschieden',
  'home.global.title': 'Über alle Wikis',
  'home.global.description': 'Wissensbereiche und die Entscheidungen, die wirklich auf einen Menschen warten.',
  'home.global.all': 'Alle Wikis',
  'home.global.production': 'Produktive Wikis',
  'home.global.open': 'Offene Entscheidungen',
  'home.global.oldest': 'Älteste Entscheidung',
  'home.global.loading': 'Wikis werden geladen…',
  'home.global.error': 'Die Wiki-Übersicht konnte nicht geladen werden.',
  'home.global.noPurpose': 'Kein Zweck beschrieben',
  'home.global.empty': 'In den produktiven Wikis wartet gerade keine Entscheidung.',
  'home.current.title': 'Im Wiki: {space}',
  'home.current.description': 'Hier findest du Wissen und Arbeit im ausgewählten Wiki.',
  'time.today': 'heute',
  'time.oneDay': '1 Tag',
  'time.days': '{count} Tage',
  'attention.state.open': 'Offen',
  'attention.state.deferred': 'Zurückgestellt',
  'attention.state.discarded': 'Verworfen',
  'attention.state.decided': 'Entschieden',
  'attention.kind.all': 'Alles',
  'attention.kind.proposal': 'Vorschlag',
  'attention.kind.triage': 'Eingang einordnen',
  'attention.kind.output': 'Ergebnis',
  ...
  'attention.effect.output': 'Hier wird entschieden, ob dieses Ergebnis in den normalen Wissensablauf gehört.',
  'decisions.filters': 'Entscheidungsfilter',
  'decisions.needsAttention': 'Braucht eine Entscheidung',
  'decisions.waitingLonger': 'Wartet länger als drei Tage',
  'decisions.loading': 'Entscheidungen werden geladen…',
  'decisions.error': 'Entscheidungen konnten nicht geladen werden',
  'decisions.overdueTitle': 'Eine Erinnerung ist überfällig',
  'decisions.overdueDescription': '{count} zurückgestellte Aufgaben haben ihren Erinnerungszeitpunkt erreicht.',
  'decisions.empty.filtered': 'Nichts passt zu diesen Filtern',
  'decisions.empty.open': 'Keine Entscheidung ist offen',
  'decisions.empty.other': 'In dieser Ansicht gibt es keine Einträge.',
  ...
  'decisions.restore': 'Wieder öffnen',
  ...
  'decisions.removeConfirmDescription':
    'Der Eintrag verschwindet aus der offenen Aufgabenliste und kann unter „Verworfen“ wieder geöffnet werden.',
  ...
  'spaces.showTests': 'Test-Wikis anzeigen',
