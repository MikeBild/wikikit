...
const EN = {
  ...
  'page.home.description': 'Find knowledge, open work and recent changes in this wiki.',
  ...
  'attention.kind.care': 'Check finding',
  'attention.currentCheck': 'Found in the current check',
  ...
  'attention.effect.care': 'The check itself changes nothing.',
...
const DE: Record<TranslationKey, string> = {
  ...
  'page.home.description': 'Wissen, offene Aufgaben und letzte Änderungen an einem Ort.',
  'page.inbox.description':
  ...
  'attention.kind.care': 'Prüfbefund',
  'attention.currentCheck': 'Im aktuellen Prüflauf gefunden',
  ...
  'attention.effect.care': 'Die Prüfung selbst ändert nichts.',
