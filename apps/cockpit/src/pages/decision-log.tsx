 ...
 */
type DecisionRow = Awaited<ReturnType<typeof wk.decisionLog.list>>['items'][number]
...
export function DecisionLogPage() {
  ...
  const query = useQuery({
    queryKey: keys.decisionLog(space, LIST_QUERY),
    queryFn: () => wk.decisionLog.list(space, LIST_QUERY),
  })
