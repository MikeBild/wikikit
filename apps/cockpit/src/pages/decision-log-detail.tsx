 ...
 */
type Decision = Awaited<ReturnType<typeof wk.decisionLog.get>>
...
export function DecisionLogDetailPage() {
  ...
  const query = useQuery({
    queryKey: keys.decisionLogEntry(space, slug),
    queryFn: () => wk.decisionLog.get(space, slug),
  })
        ...
        <div className="flex flex-col gap-1">
          ...
          {replacedBy.length > 0 ? (
            ...
            <span className="text-muted-foreground">
              ...
              <Link to="/decision-log" data-testid="decision-back-to-log" className="underline underline-offset-2">
                decision log
              </Link>{' '}
