...
export function renderProviderChoice(options: {
  ...
  return shell(
    'Sign in',
    `<h1>Sign in to WikiKit</h1><p class="muted">Choose how to authenticate this authorization request.</p><ul class="providers">${providers}</ul>`,
  )
}
